...
export default function Home(){
    ...
    return (
        <Grid id="home" container height="calc(100vh - 64px)" sx={{bgcolor:theme.palette.background.default}}>
            ...
            <Grid xs={5} sx={{bgcolor:theme.palette.background.default}}>
              <Image alt="background_image" src="/assets/images/web_desn_img.png" layout="intrinsic" height="2500" width="2500"/>
              <Box/>
            </Grid>
        </Grid>
    );
