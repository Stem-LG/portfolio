...
export default () => {
    ...
    const [message, messageValid, verifyMessage] = useLengthVerifier("", 15,500);
    ...
    return (
        ...
        >
            ...
            <Grid container justifyContent="space-evenly">
                ...
                >
                    <Button variant="contained" sx={{ width: 300 }} color={sendColor} onClick={submitMessage}>
                        {sendText}
                    </Button>
                </Grid>
            </Grid>
